...
def register(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			message = render_to_string('accounts/accountverificationemail.html', {
				'user': user,
				'domain': current_site,
			...
			send_email.send()
#			messages.success(request, 'Thank you for registering with us. Please click on the link in your email to activate your account')
